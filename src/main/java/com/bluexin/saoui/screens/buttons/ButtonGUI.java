...
public class ButtonGUI extends Elements {
    ...
    protected ButtonGUI(ParentElement gui, Categories saoID, int xPos, int yPos, int w, int h, String string, IconCore saoIcon) {
    ...
    private ButtonGUI(ParentElement gui, Categories saoID, int xPos, int yPos, int w, String string, IconCore saoIcon) {
        this(gui, saoID, xPos, yPos, w, 20, string, saoIcon);
    }

    public ButtonGUI(ParentElement gui, Categories saoID, int xPos, int yPos, String string, IconCore saoIcon) {
        this(gui, saoID, xPos, yPos, 100, string, saoIcon);
    }

    public ButtonGUI(ParentElement gui, Categories saoID, int xPos, int yPos, String string, IconCore saoIcon, boolean highlighted) {
        this(gui, saoID, xPos, yPos, 100, string, saoIcon);
