...
public class SAORenderPlayer extends RenderPlayer {
    ...
    @Override
    public boolean shouldRender(AbstractClientPlayer p_177071_1_, ICamera p_177071_2_, double p_177071_3_, double p_177071_5_, double p_177071_7_) {
        return this.trueRenderer.shouldRender(p_177071_1_, p_177071_2_, p_177071_3_, p_177071_5_, p_177071_7_);
    }

    @Override
    public void doRender(AbstractClientPlayer entity, double x, double y, double z, float f0, float f1) {
