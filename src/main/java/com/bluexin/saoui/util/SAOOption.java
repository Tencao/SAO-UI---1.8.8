...
public enum SAOOption {
    ...
    CURSOR_MOVEMENT(StatCollector.translateToLocal("optionCursorMov"), true, false, EFFECTS, false),
    ...
    SAOOption(String optionName, boolean defaultValue, boolean isCat, SAOOption category, boolean onlyOne) {
        name = optionName;
        value = defaultValue;
        isCategory = isCat;
    ...
    public static String getTheme(){
        return Stream.of(values()).filter(category -> category == THEME).filter(option -> option.getValue()).toString();
    }
